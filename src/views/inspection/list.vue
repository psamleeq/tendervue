	...
	<div class="app-container road-case" v-loading="loading">
        ...
        <div style="display:flex">
            ...
            <div style="margin:10px 10px">
                <inspection-list-pdf 
                    ref="inspectionListPdf" 
                    style="margin-left:10xp"
		...
		>
			...
			<el-table-column label="狀態" align="center">
				<template slot-scope="{ row }">
                    ...
                    <span>
						<el-button class="btn-action" type="primary" plain size="mini" round @click="caseEdit()">編輯</el-button>
					</span>
				</template>
			</el-table-column>
            ...
            <el-table-column label="列印狀態" align="center" width="80">
			</el-table-column>
		</el-table>
...
export default {
	name: "roadCase",
	components: { InspectionListPdf, Pagination, ElImageViewer, MapViewer },
	data() {
		return {
			loading: false,
			showImgViewer: false,
	...
	methods: {
        downloadPdf(callback) {
			this.$confirm(`確認列印？`, "確認", { showClose: false })
				.then(() => {
						this.$message({
							message: `成功列印`,
							type: "success",
